...
from two_dim_surface_plot import plot_surface
"""
This script computes the solution to the 2D-time independent Schrödinger equation. This is an eigenvalue problem and we use FeniCSx with SLEPc.
"""
# Set paramerts: Domain Length, number of finite elements 
L = 3 # Domain length [-L/2, L/2]
N = 64 # Number of finite elements
...
# Assemble the stiffness matrix; apply our boundary conditions
A = assemble_matrix(fem.form(a), bcs = [bc])
A.assemble()

# Create the mass matrix for the eigenvalue problem and apply boundary conditions
...
# Extract eigenvalues. Ground state should be 1
eigenvalues = []
...
# Now we can compute the L2 and H1 error
...
plot_surface(domain, uh, error_L2, error_H1, N)
