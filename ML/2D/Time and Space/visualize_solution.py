...
# Setup grid and time
n_points = 70
x = torch.linspace(-3.5, 3.5, n_points)
y = torch.linspace(-3.5, 3.5, n_points)
...
plt.xlabel("Time t")
plt.ylabel(r"$\int \int |\psi(x,t)|^2 dxdy$")
...
ax1.set_zlabel('$\psi_{real}$')
ax2.set_zlabel('$\psi_{imag}$')
ax3.set_zlabel('$|\psi|^2$')
